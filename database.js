// database.js
// Expanded with Horror, Sci-Fi Franchises, and Action Series
const MOVIE_DB = [
    // --- HORROR (New Additions) ---
    { title: "Scream", cast: ["Neve Campbell", "Courteney Cox", "David Arquette", "Matthew Lillard", "Drew Barrymore", "Skeet Ulrich"] },
    { title: "The Conjuring", cast: ["Patrick Wilson", "Vera Farmiga", "Ron Livingston", "Lili Taylor"] },
    { title: "It (2017)", cast: ["Bill Skarsgård", "Jaeden Martell", "Finn Wolfhard", "Sophia Lillis"] },
    { title: "Get Out", cast: ["Daniel Kaluuya", "Allison Williams", "Bradley Whitford", "Catherine Keener", "LaKeith Stanfield"] },
    { title: "Halloween (1978)", cast: ["Jamie Lee Curtis", "Donald Pleasence", "P.J. Soles"] },
    { title: "The Shining", cast: ["Jack Nicholson", "Shelley Duvall", "Danny Lloyd", "Scatman Crothers"] },
    { title: "The Silence of the Lambs", cast: ["Jodie Foster", "Anthony Hopkins", "Scott Glenn", "Ted Levine"] },
    { title: "Alien", cast: ["Sigourney Weaver", "Tom Skerritt", "John Hurt", "Ian Holm", "Harry Dean Stanton"] },
    { title: "A Quiet Place", cast: ["Emily Blunt", "John Krasinski", "Millicent Simmonds", "Noah Jupe"] },
    { title: "Sixth Sense", cast: ["Bruce Willis", "Haley Joel Osment", "Toni Collette"] },

    // --- FRANCHISES: ACTION & SCI-FI (New Additions) ---
    // Mission Impossible
    { title: "Mission: Impossible", cast: ["Tom Cruise", "Jon Voight", "Emmanuelle Béart", "Ving Rhames", "Jean Reno"] },
    { title: "Mission: Impossible - Fallout", cast: ["Tom Cruise", "Henry Cavill", "Ving Rhames", "Simon Pegg", "Rebecca Ferguson", "Vanessa Kirby", "Angela Bassett"] },
    
    // Fast & Furious
    { title: "The Fast and the Furious", cast: ["Vin Diesel", "Paul Walker", "Michelle Rodriguez", "Jordana Brewster"] },
    { title: "Fast Five", cast: ["Vin Diesel", "Paul Walker", "Dwayne Johnson", "Jordana Brewster", "Tyrese Gibson", "Ludacris", "Gal Gadot"] },
    { title: "Furious 7", cast: ["Vin Diesel", "Paul Walker", "Dwayne Johnson", "Michelle Rodriguez", "Jason Statham", "Kurt Russell"] },

    // Jurassic Park
    { title: "Jurassic Park", cast: ["Sam Neill", "Laura Dern", "Jeff Goldblum", "Richard Attenborough", "Samuel L. Jackson"] },
    { title: "Jurassic World", cast: ["Chris Pratt", "Bryce Dallas Howard", "Vincent D'Onofrio", "Judy Greer"] },

    // Avatar
    { title: "Avatar", cast: ["Sam Worthington", "Zoe Saldana", "Sigourney Weaver", "Stephen Lang", "Michelle Rodriguez"] },

    // Indiana Jones
    { title: "Raiders of the Lost Ark", cast: ["Harrison Ford", "Karen Allen", "Paul Freeman", "John Rhys-Davies"] },
    { title: "Indiana Jones and the Last Crusade", cast: ["Harrison Ford", "Sean Connery", "Denholm Elliott", "River Phoenix"] },

    // Back to the Future
    { title: "Back to the Future", cast: ["Michael J. Fox", "Christopher Lloyd", "Lea Thompson", "Crispin Glover"] },

    // Ghostbusters
    { title: "Ghostbusters (1984)", cast: ["Bill Murray", "Dan Aykroyd", "Sigourney Weaver", "Harold Ramis", "Rick Moranis"] },

    // --- DRAMA & CULT CLASSICS ---
    { title: "What's Love Got to Do with It", cast: ["Angela Bassett", "Laurence Fishburne", "Vanessa Bell Calloway", "Jenifer Lewis"] },
    { title: "Boyz n the Hood", cast: ["Cuba Gooding Jr.", "Ice Cube", "Morris Chestnut", "Laurence Fishburne", "Angela Bassett", "Regina King", "Nia Long"] },
    { title: "Akeelah and the Bee", cast: ["Keke Palmer", "Laurence Fishburne", "Angela Bassett", "Curtis Armstrong"] },
    { title: "Jerry Maguire", cast: ["Tom Cruise", "Cuba Gooding Jr.", "Renée Zellweger", "Kelly Preston", "Jerry O'Connell", "Regina King"] },
    { title: "Friday", cast: ["Ice Cube", "Chris Tucker", "Nia Long", "Tiny Lister", "John Witherspoon", "Regina King"] },
    { title: "Ray", cast: ["Jamie Foxx", "Kerry Washington", "Regina King", "Clifton Powell", "Harry Lennix"] },
